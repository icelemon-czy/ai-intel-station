...
sources:
  ...
  wechat:
    enabled: true                    # optional WeChat source; failures do not block a completed HN sweep
...
briefing:
  ...
  wechat_max_items: 2                # at most 2 deduped WeChat entries
  x_items: 0                         # disabled by default with sources.x.enabled
  github_items: 1
  paper_items: 1
