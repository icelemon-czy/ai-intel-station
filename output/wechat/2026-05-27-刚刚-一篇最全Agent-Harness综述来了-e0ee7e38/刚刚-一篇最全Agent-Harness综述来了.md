...
> 原文链接: https://mp.weixin.qq.com/s/pG39PRnZFjSIxwYcPKD47A
...
![论文 Figure 1：Prompt、Context 和 Harness Engineering 的区别。](images/img_002.png)
...
![论文 Figure 2：Agent Harness Engineering 的七层结构。](images/img_003.png)
...
![论文 Figure 11：Agent 验证与评估的 task-to-feedback 生命周期。](images/img_004.png)
...
![论文 Figure 3：2022-2026 Agent Harness 系统演进时间线。](images/img_005.png)
