...
> 公众号: 单向箔
> 发布时间: 2026-04-05 03:13
> 原文链接: https://mp.weixin.qq.com/s/tT97gfbc_3lJkVuaUtmRpg
...
![Gemini_Generated_Image_ahu8cgahu8cgahu8.png](images/img_001.png)这就是为什么前段时间总有人质疑 AI 编码怎么敢在生产上实际使用的原因，也正是现在 Harness 开始变得越来越重要的原因。
...
![Gemini_Generated_Image_phwvnpphwvnpphwv.png](images/img_002.png)如果只用一句话概括 OpenSpec，那就是：
...
![Gemini_Generated_Image_tt26sott26sott26.png](images/img_003.png)Superpowers 的定位也非常清楚，它不是把自己描述成“完整工程平台”，而是：
...
![Gemini_Generated_Image_2lpzin2lpzin2lpz.png](images/img_004.png)GSD 的定位也很鲜明，它在 README 里几乎是直接把卖点写在脸上：
...
![Gemini_Generated_Image_owa52aowa52aowa5.png](images/img_005.png)如果说 OpenSpec 解决“别乱开始”，GSD 解决“别把上下文聊烂”，那 OMC 主要解决的是另一类问题：
...
![Gemini_Generated_Image_l41uxol41uxol41u.png](images/img_006.png)ECC 是这几个项目里最容易被误读的一个。
...
![Gemini_Generated_Image_vm29vpvm29vpvm29.png](images/img_007.png)我把 Trellis 放到最后，是因为它和前面几个的模式又有不同。（*当然也因为是社区内的佬做的，所以稍微有一些私心*）
...
![Gemini_Generated_Image_anut2banut2banut.png](images/img_008.png)我更建议把 Harness 理解成一个**分层搭建、按缺口补位的问题**，而不是单工具选择题。
...
![Gemini_Generated_Image_etsqajetsqajetsq.png](images/img_009.png)先说明一点：框架当然是可以搭配，但这不代表你应该一上来就像叠甲一样哐哐的叠很多层。
...
- 多个 agent 方式同时上场，到底是在协作，还是在制造更大的回收成本？![Gemini_Generated_Image_aguctzaguctzaguc.png](images/img_010.png)从社区实战反馈里，至少能提炼出几条很值得写进文章的校正结论。
...
我看到的，现在对于 Harness 体系的搭建，分为三类人：![Gemini_Generated_Image_9fxvj69fxvj69fxv.png](images/img_011.png)
