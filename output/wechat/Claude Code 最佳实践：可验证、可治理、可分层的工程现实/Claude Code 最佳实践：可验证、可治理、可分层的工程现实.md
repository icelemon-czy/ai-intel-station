...
> 公众号: 架构师
> 发布时间: 2026-03-13 23:29
> 原文链接: https://mp.weixin.qq.com/s/Suhxzr-KUw78RPTU6nn1gA?scene=1
...
如果你最近连续看了我们这组文章，这篇其实也可以看成一次“收束”——从 [Harness Engineering](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408765&idx=1&sn=62bc37d9672262334fa3aa5d7c77d8f4&scene=21#wechat_redirect) 的反馈回路，到[架构师责任上移](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408781&idx=1&sn=24282544baecf5233f1f0a65f5e40987&scene=21#wechat_redirect)，到 [Skills 工作流沉淀](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408385&idx=1&sn=3425cb256cb9cef30d43afd1e1165e1b&scene=21#wechat_redirect)、[上下文窗口治理](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408774&idx=1&sn=2cba06288b0f507bb630f83fd04038bf&scene=21#wechat_redirect)、[Agent 安全三层防线](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408462&idx=1&sn=e2932c687af7d23f462f58f46caab653&scene=21#wechat_redirect)，再到 [AI 记忆系统的分层设计](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408756&idx=1&sn=03188bfa5d034a1b5ca0347c72b673fd&scene=21#wechat_redirect)——这些线索合起来看 Claude Code，很多问题会清楚得多。
...
1. 1. 任务循环：收集上下文、采取行动、验证结果
2. 2. 常驻契约：`CLAUDE.md`、Memory、项目禁区和构建命令
3. 3. 工作流层：Skills、rules、可复用的执行顺序
4. 4. 动作层：Tools、MCP、CLI、外部系统接入
5. 5. 控制层：Hooks、权限、沙箱、审批和审计
6. 6. 隔离层：Subagents、并行调查、长任务分流
...
| 层级 | 应该放什么 | 不该放什么 |
| --- | --- | --- |
| `CLAUDE.md` | 构建命令、禁用事项、项目契约、必须遵守的边界 | 大段背景资料、低频操作手册、领域教程 |
| `rules` | 路径级、语言级、文件类型级约束 | 全项目通用规则 |
| `skills` | 任务型工作流、低频但可复用的领域知识 | 每次会话都要加载的常驻规则 |
| `hooks` | 硬性校验、审计、阻断、确定性脚本 | 复杂语义判断、多步推理 |
| `subagents` | 大量探索、并行研究、高噪音调查 | 强依赖共享中间状态的小任务 |
...
Prompt 缓存按前缀匹配工作，从请求开头到每个 cache\_control 断点之前的内容都会被缓存。所以顺序很重要：
...
| 篇目 | 核心关键词 | 和 Claude Code 的关系 |
| --- | --- | --- |
| [《OpenAI 工程师不写代码了？拆开 Harness Engineering》](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408765&idx=1&sn=62bc37d9672262334fa3aa5d7c77d8f4&scene=21#wechat_redirect) | **反馈回路** | Agent 不只生成代码，还得看界面、看日志、跑验证、接 review |
| [《当AI完成了大部分代码，架构师何去何从》](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408781&idx=1&sn=24282544baecf5233f1f0a65f5e40987&scene=21#wechat_redirect) | **责任上移** | 实现越自动化，验证、观测、约束和回滚越值钱 |
| [《2026 AI Memory 综述：从4W分类到系统落地》](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408756&idx=1&sn=03188bfa5d034a1b5ca0347c72b673fd&scene=21#wechat_redirect) | **记忆分层** | 工作记忆、语义记忆、情景记忆的分层，和 Claude Code 的上下文分层设计异曲同工 |
| [《Skills 详解：Anthropic和OpenAI的路线差异》](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408639&idx=1&sn=ad325d5fa3dd0e112d62b0e34ea3c48a&scene=21#wechat_redirect) | **工作流沉淀** | Skill 不是更长的 Prompt，而是团队可复用的方法入口 |
| 《[深入解析 OpenClaw](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408774&idx=1&sn=2cba06288b0f507bb630f83fd04038bf&scene=21#wechat_redirect)[上下文窗口压缩](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408774&idx=1&sn=2cba06288b0f507bb630f83fd04038bf&scene=21#wechat_redirect)》 | **长会话治理** | 上下文管理不是做摘要，而是做保真和降噪 |
| 《[从误删邮箱到 Skill 投毒：OpenClaw 安全到底该怎么做](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408683&idx=1&sn=afd67e40b84846b7e0006c08cb97cb04&scene=21#wechat_redirect)》 | **系统边界** | 规则要进机制，不能只停留在对话层 |
| 《[你的"法学硕士"会写合理的代码，只是不一定会把系统写对](https://mp.weixin.qq.com/s?__biz=MzAwNjQwNzU2NQ==&mid=2650408664&idx=1&sn=7c81b28f407db9228e419e338799bba6&scene=21#wechat_redirect)》 | **验证先行** | LLM 写的代码可以编译、可以过测试，但关键路径上可能根本没做对 |
