...
The workspace SHALL expose a GitHub collect capability that fetches repository metadata and search results through the unified collect surface.
...
The workspace SHALL expose a papers collect capability that fetches arXiv papers by category through the unified collect surface.
