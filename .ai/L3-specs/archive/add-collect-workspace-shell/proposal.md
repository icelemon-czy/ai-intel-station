...
- `2026-06-01` — `pending-review` → `approved` by `/review-tests` | 原因: delta spec 占位符已补全，测试全绿

## Review Feedback

- [x] 2026-06-01 review-tests: delta spec 中 `research-web-workspace/spec.md` 和 `research-operations/spec.md` 使用 `[完整描述]` 占位符而非真实 Requirement 内容。已补全所有 Scenario 的完整 WHEN/THEN 描述，与主 spec 语义保持一致。
