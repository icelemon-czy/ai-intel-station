...
> **层级**: HLR（High-Level Requirement）
> **上级**: system.md

## Purpose

Define the unified operator-facing command surface that organizes research workflow by business action (collect, query, briefing, backfill) instead of by source-specific script.
