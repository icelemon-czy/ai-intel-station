...
| GitHub Evidence Role | Fresh repo enters only dedicated lane with source-time fallback | `library/items.py`, `briefing/signals.py::select_daily_briefing` | `tests/test_realtime_signals.py` dedicated composition, created-first and published fallback assertions | ✅ verified |
