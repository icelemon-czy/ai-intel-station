...
| Latest Papers by Category | Fetch one category | `collect/papers.py::fetch_papers_by_category` | `tests/test_l3_subspec_remaining_e2e.py`, `tests/test_papers_atom_parse.py`, `tests/test_l3_http_e2e.py` | ✅ verified |
...
| Papers Evidence Role | Fresh Paper enters only dedicated arXiv lane | `library/items.py`, `briefing/signals.py::select_daily_briefing` | `tests/test_realtime_signals.py` dedicated composition/latest publication/stale exclusion assertions | ✅ verified |
