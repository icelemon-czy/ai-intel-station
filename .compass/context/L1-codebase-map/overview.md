...
- **技术栈**: Python CLI + uv + optional pytest + gh CLI + arXiv API + optional WeChat browser stack + React / Vite
...
| Agent-first 每日情报 | Agent 直接执行 discovery、读取 briefing 并在 conversation 返回重点 | → `features/research-operations/` | `.agents/skills/daily-discovery/SKILL.md` |
