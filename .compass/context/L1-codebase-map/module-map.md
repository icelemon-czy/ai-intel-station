...
| daily signal contract | `briefing/signals.py` + `research/discovery/runner.py` | `signal` 填 News；fresh GitHub/Papers evidence 填 dedicated lane；quota/status 区分 shortfall、完整空结果与 coverage failure |
