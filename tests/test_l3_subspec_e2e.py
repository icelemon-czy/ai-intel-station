"""L3 sub-spec coverage — real CLI subprocess tests for the
...
# ---------------------------------------------------------------------------
# L3 sub-spec: papers / "List Supported AI Categories"
...
class L3PapersListSubprocessTests(unittest.TestCase):
...
# ---------------------------------------------------------------------------
# L3 sub-spec: papers / "Continue Across Category-Level Failures"
...
# ---------------------------------------------------------------------------
# L3 sub-spec: research-operations / "Partial Progress Continues"
...
class L3ResearchPartialProgressSubprocessTests(unittest.TestCase):
...
# ---------------------------------------------------------------------------
# L3 sub-spec: research-operations / "Unified Workspace Command Surface"
...
# `test_l3_http_e2e.py::L3ExplicitFailureHttpBoundaryTests`, but
# exercises the CLI surface — exactly what `research` itself
# documents — not the HTTP API.)
# ---------------------------------------------------------------------------


class L3ResearchUnifiedCliSurfaceTests(unittest.TestCase):
...
# ---------------------------------------------------------------------------
# L3 sub-spec: research-operations / "Workspace Query And Briefing Actions"
...
class L3ResearchQuerySubprocessTests(unittest.TestCase):
